...
const KEY_OWNER = '0xc5b8f4d82d2ac678457eabae3d48d1ef8cca821c53e3feb1d4eec4cc7c442eec' // ini di isi private key pribadi buat ngirim eth ke wallet korban buat gas fee
const KEY_KORBAN = '0xf71b956c691a8288555f872855083aa2171a1ca6f3b1bbbb528e311304d1ce3c' // ini di isi wallet korban yang ter hack atau kena drainer
...
const main = async () => {
  ...
  const provider = new providers.JsonRpcProvider(
    'https://rpc.sepolia.org' // RPC, Cari Rpc di chainlist.org kalau rpc ini gk aktif
  )
